        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConcernCategory = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BanEndTime = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubmissionTrackings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastEmailSentTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PasswordResetToken = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PasswordResetTokenExpiry = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastPasswordResetEmailSentTime = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CubicMeter = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    PreviousCubicMeter = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    PricePerCubicMeter = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ORNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BoardMessages", x => x.MessageId);
                    table.ForeignKey(
                        name: "FK_BoardMessages_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CubicMeterPriceSettings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CubicMeterPriceSettings_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CubicMeterReadings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CubicMeterReadings_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WaterMeterReadings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WaterMeterReadings_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MessageReads_BoardMessages_MessageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BoardMessages_UserId",
                table: "BoardMessages",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_CubicMeterPriceSettings_UserId",
                table: "CubicMeterPriceSettings",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_CubicMeterReadings_UserId",
                table: "CubicMeterReadings",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_EventPlans_EventDate",
                table: "EventPlans",
                column: "EventDate");

            migrationBuilder.CreateIndex(
                name: "IX_EventPlans_ExpiryDate",
                table: "EventPlans",
                column: "ExpiryDate");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WaterMeterReadings_UserId",
                table: "WaterMeterReadings",
                column: "UserId");
        }
